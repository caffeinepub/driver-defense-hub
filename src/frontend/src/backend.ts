...
import type { AdminAction as _AdminAction, AdminActionType as _AdminActionType, ExternalBlob as _ExternalBlob, GalleryImage as _GalleryImage, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async blockUser(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAdminActivityLog(): Promise<Array<AdminAction>> {
        if (this.processError) {
            try {
    ...
    async getAllLegalDefenses(): Promise<Array<LegalDefense>> {
        if (this.processError) {
            try {
    ...
    async getAllUsers(): Promise<Array<UserProfileWithPrincipal>> {
        if (this.processError) {
            try {
    ...
    async unblockUser(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async uploadGalleryImage(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadGalleryImage(arg0, arg1, arg2, await to_candid_ExternalBlob_n22(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AdminActionType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AdminActionType): AdminActionType {
    return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function from_candid_AdminAction_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AdminAction): AdminAction {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        action: from_candid_AdminActionType_n13(_uploadFile, _downloadFile, value.action),
        admin: value.admin,
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AdminAction>): Array<AdminAction> {
    return value.map((x)=>from_candid_AdminAction_n11(_uploadFile, _downloadFile, x));
}
